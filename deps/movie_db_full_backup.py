"""
Welcome to the source code for 'Netflix and Chill' v1.0.2
This is a program that pulls movie information from a basic 20 movie SQL database
...
Release Year (2)
IMDb Rating (3)
Custom SQL Command Insertion (Advanced Users) (4)
